...
function DashboardHeader() {
    ...
    return (
        <>
            ...
            <div className="row d-flex justify-content-between shadow page-header">
            ...
            <div className={`w3-sidebar sidebar-custom-css w3-bar-block w3-border-right ${SidenavOpen ? "mySidebarOpened" : "mySidebarClosed"}`}>
